...
namespace YTSoft.CC.Grains.XsTaskBaseManager.Repository
{
    public interface IXsTaskBaseRepository : IBaseRepository<XsTaskBaseDO>
    {
    }

    [ServiceDescriptor(typeof(IXsTaskBaseRepository), ServiceLifetime.Transient)]
    public class XsTaskBaseRepository : BaseRepository<XsTaskBaseDO>, IXsTaskBaseRepository
    {
        public XsTaskBaseRepository(IConfiguration configuration) : base(configuration)
        {
        }
