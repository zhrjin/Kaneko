...
namespace Kaneko.Core.DependencyInjection
{
    ...
    {
        private static readonly ConcurrentDictionary<int, ServiceTypeMetadata> serviceTypesMetadataList =
        ...
        public static ServiceTypeMetadata GetServiceTypeMetadata(Type serviceType, int serviceKey)
        {
            ...
            if (!serviceTypesMetadataList.TryGetValue(key, out ServiceTypeMetadata metadata))
            {
